...
<body>
    <div class="page-container">
        <form action="/Flfw/index/ProductUpdate.action" method="post" class="form form-horizontal" id="form-article-add">
            
          <div class="row cl" style="display: none;">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>Id：</label>
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" class="input-text" value=${product.id} placeholder="" id="" name="id">
            </div>
          </div>
          <div class="row cl" style="display: none;">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>categoryId：</label>
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" class="input-text" value=${product.categoryId} placeholder="" id="categoryId">
            </div>
          </div>
          <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" class="input-text" value=${product.name} placeholder="" id="" name="name">
            </div>
          </div>
          <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">简略标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
              <input name="subtitle" type="text" class="input-text" value=${product.subtitle} placeholder="" id="" >
            </div>
          </div>
          <div class="row cl">
          ...
          <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" name="stock" id="" placeholder="" value=${product.stock} class="input-text" style="width:90%">
              件</div>
          </div>
          <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">折扣价：</label>
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" name="priceNow" id="" placeholder="" value=${product.priceNow} class="input-text" style="width:90%">
              元</div>
          </div>
          <!-- <div class="row cl">
          ...
          <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" name="priceOriginal" id="" placeholder="" value=${product.priceOriginal} class="input-text" style="width:90%">
              元</div>
          </div>
          <div style="display: none">
            <!-- <input type="text" name="mainImage" id="" placeholder="" value=${product.mainImage} class="input-text" style="width:90%" style="display: none"> -->
            <!-- <input type="text" name="subImages" id="" placeholder="" value=${product.subImages} class="input-text" style="width:90%" style="display: none"> -->
            <!-- <input type="text" name="detailImage" id="" placeholder="" value=${product.detailImage} class="input-text" style="width:90%" style="display: none"> -->
            <!-- <input type="text" name="status" id="" placeholder="" value=${product.status} class="input-text" style="width:90%" style="display: none"> -->
            <!-- <input type="text" name="sellNumber" id="" placeholder="" value=${product.sellNumber} class="input-text" style="width:90%" style="display: none"> -->
          </div>
...
<!--           
              ...
              <div class="uploader-thum-container">
                <div style="margin-bottom: 20px">
                  ...
                  <s:iterator value="#request.product.subImages">
                    <img style="width: 100px" src=<s:property/> />
                  </s:iterator>
                </div>
          ...
          <div class="row cl"> -->
            ...
            <div class="formControls col-xs-8 col-sm-9"> 
              <script name="detail" id="editor" type="text/plain" style="width:100%;height:400px;" ng-value=${product.detail} ></script> 
            </div>
          </div>
          <div class="row cl">
