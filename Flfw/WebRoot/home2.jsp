...
<html xmlns="http://www.w3.org/1999/xhtml">
				    ...
				    success:function(data){
				        ...
				        $.each(CategoryList,function(index,item){
				            ...
				            $.each(item.childList,function(childIndex,childItem){
				                ...
				                //<dd>< a href=' '><span>è¿å£æ´é</span></ a></dd>
				            });
	...
	<body>
			...
			<div class="am-container header">
				...
				<ul class="message-r">
					<div class="topMessage home">
						<div class="menu-hd"><a href="##" target="_top" class="h" >XXX商品</a></div>
					</div>
					<div class="topMessage my-shangcheng">
						<div class="menu-hd MyShangcheng"><a href="#" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
					</div>
					<div class="topMessage mini-cart">
						<div class="menu-hd"><a id="mc-menu-hd" href="showshopcart.action" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
					</div>
					<div class="topMessage favorite">
						<div class="menu-hd"><a href="increaseProductCart.action" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>加入购物车</span></a></div>
				</ul>
				</div>
		...
		<div class="navCir">
			...
			<li><a href="shopcart.action"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
