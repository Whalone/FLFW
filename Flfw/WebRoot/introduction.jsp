	...
	<head>
		...
		<script type="text/javascript">
			function AddCart(productId){
				var buy_quantity=document.getElementById("text_box").value;
				var price_now=10;
				$.ajax({
				    type:'post',
				    url:'increaseProductCart',
				    dataType:'json',
				   	data:{"productId":productId,"quantity":buy_quantity,"price_now":price_now},
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="" onclick="AddCart(26)"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
