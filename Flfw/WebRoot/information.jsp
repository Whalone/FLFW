...
<html>
	...
	<head>
		...
		<link href="./flfw/css/infstyle.css" rel="stylesheet" type="text/css">
			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<!--个人信息 -->
						<div class="info-main">
							<form class="am-form am-form-horizontal" id="update" action="updateInformation" method="post">
								<span style="color:red;font-size:10px;text-align:center;"><s:fielderror><s:param>nickname</s:param></s:fielderror></span>
								<div class="am-form-group">
									<label for="user-name2" class="am-form-label">昵称</label>
									<div class="am-form-content">
										<input type="text" id="user-name2" name="nickname" placeholder="nickname" value="${user.nickname}">
								...
								<span style="color:red;font-size:10px;text-align:center;"><s:fielderror><s:param>phone</s:param></s:fielderror></span>
								<div class="am-form-group">
									<label for="user-phone" class="am-form-label">电话</label>
									<div class="am-form-content">
										<input id="user-phone" name="phone" placeholder="telephonenumber" type="tel" value="${user.phone}">
								...
								<div class="info-btn">
									<div class="am-btn am-btn-danger" onclick="submit('update');">保存修改</div>
								</div>
